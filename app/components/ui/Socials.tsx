...
export function Socials() {
  ...
  return (
    <div className="h-48 relative md:w-22 w-full overflow-hidden bg-transparent flex flex-col items-center justify-center rounded-lg mt-4 md:mt-0 md:ml-12 hover:bg-black border hover:-translate-y-3.5  md:hover:-translate-y-1/4 transition-transform duration-300 border-white">
