...
export function Learning() {
  return (
    <div className="h-48 relative w-96 overflow-hidden bg-transparent flex flex-col items-center justify-center rounded-lg mt-4 ml-12 hover:bg-black border border-white hover:-translate-y-1/4 transition-transform duration-300">
